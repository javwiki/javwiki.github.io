...
class FanzaActressRankingSpider:
    ...
    def __init__(self, output_dir: str = "../../docs/zh/排名", proxy: str = "socks5://127.0.0.1:7890"):
...
def main():
    ...
    parser.add_argument("--output", type=str, default="../../docs/zh/排名", help="Output directory")
